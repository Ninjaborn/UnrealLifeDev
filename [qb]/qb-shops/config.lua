...
Config.Products = {
    ['normal'] = {
        ...
        { name = 'corn_seed',     price = 5,   amount = 100 },
        { name = 'tomato_seed',   price = 5,   amount = 100 },
        { name = 'wheat_seed',    price = 5,   amount = 100 },
        { name = 'broccoli_seed', price = 5,   amount = 100 },
        { name = 'carrot_seed',   price = 5,   amount = 100 },
        { name = 'potato_seed',   price = 5,   amount = 100 },
        { name = 'pickle_seed',   price = 5,   amount = 100 },
    },
    ['liquor'] = {
        { name = 'beer',    price = 7,  amount = 50 },
        { name = 'whiskey', price = 10, amount = 50 },
